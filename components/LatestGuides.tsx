  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto my-10">
      <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Latest User Guides</h2>
        <p className="mt-1 text-gray-600 dark:text-gray-400">Learn about the latest products that have been released.</p>
      </div>
